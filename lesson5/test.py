...
#
#     cars = [
#         {"title": "BMW_M3_GTR", "COUNTRY": "GERMANY", 'TYPE': "SPORT"},
#         {"title": "LEXUS_RX_300", "COUNTRY": "JAPAN", 'TYPE': "MODERN"},
#         {"title": "Chevrolet_impala", "COUNTRY": "USA", 'TYPE': "OLDER"},
#     ]
#     #1 добавить еше 5 машин разного класса и разного типа
#     #2 создать функцию для распределения списка по типам машин sport older modern
#     #3 вывести на экран (задание похожее то что я показывал на лекции)
#
#
#
#
